...
class BOTE_V4(nn.Module):
    def __init__(self, embedding_matrix, opt, idx2tag, idx2polarity):
        ...
        self.ap_fc2 = nn.Linear(2*reduc_dim, 200)
        self.op_fc2 = nn.Linear(2*reduc_dim, 200)
    ...
    def forward(self, inputs):
        ...
        #reduc1, reduc2 = torch.chunk(reduc, 2, dim=2)
        #reduc = (reduc1 + reduc2)/2
