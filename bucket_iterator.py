...
class BucketIteratorBert(object):
    ...
    def pad_data(batch_data):
        ...
        #j = 0
        for item in batch_data:
            text_indices, ap_indices, op_indices, triplet_indices, ap_spans, op_spans, triplets, text_indices_bert, position_bert_in_naive, postag_indices  = \
                item['text_indices'], item['ap_indices'], item['op_indices'], item['triplet_indices'], \
                item['ap_spans'], item['op_spans'], item['triplets'], item['text_indices_bert'], item['position_bert_in_naive'], item['postag_indices']
